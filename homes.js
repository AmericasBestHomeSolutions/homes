...
/* --- the homes (171 live, rebuilt from master published 2026-07-22) --- */
const HOMES = [
  {
  ...
  },
  {
    ...
    zip:         "62206.0",
    description: "This was recently cleaned out. There is a fence around the property, it appears like just the gate at the side of the house needs to be installed for it to be fully fenced.. We are asking you to let any potential buyer know they need 3x the monthly mortgage as income but we do not require pay stubs to be sent, just a verbal acknowledgement. taxes are high on this one, $176.83 monthly",
    city:  "Cahokia",
    state: "IL",
    beds:  3,
    baths: 1,
